...
module.exports = class Book extends EventEmitter {
    ...
    createRuntime() {
        ...
        this.runtime.stdout.on('data', data => this.emit('runtime:stdout', { data: data.toString() }));
        this.runtime.stderr.on('data', data => this.emit('runtime:stderr', { data: data.toString() }));

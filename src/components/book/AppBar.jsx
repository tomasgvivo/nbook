...
import { faSquare, faTrash, faSync, faSave, faPlay, faForward, faBook, faEye, faEyeSlash, faPrint, faStop } from '@fortawesome/free-solid-svg-icons'
import ResourceGraph from './ResourceGraph';
import Action from './Action';
const prettyBytes = require('pretty-bytes');

export default ({ title, stats, status, actions, focus, saved, isCodeHidden, progress }) => {
    return (
